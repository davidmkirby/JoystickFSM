...
#ifndef LIBINPUT_HELPER_H
#define LIBINPUT_HELPER_H
...
public:
    ...
    QVector<DeviceInfo> findInputDevices(const QString& type = "joystick");
...
private:
    ...
    bool isDeviceOfType(libinput_device* device, const QString& type);
