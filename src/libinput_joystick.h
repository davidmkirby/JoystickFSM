...
#ifndef LIBINPUT_JOYSTICK_H
#define LIBINPUT_JOYSTICK_H
...
/**
 * Joystick implementation using libinput backend
 * Suitable for Wayland and modern Linux systems
 */
...
public:
    /**
     * Constructor
     * @param device_path Path to the device (sysfs or device node)
     */
